...
int a[102];
int dp[2][2][2][102];
int fun(int g, int c, int r, int idx)
{
  if (idx > n)
  {
    return  0;
  ...
  if (x == 0)
  {
    return dp[g][c][r][idx] = 1 + fun(0, 0, 1, idx + 1);
  }
  else if (x == 1)
  {
    if (c == 1)
    {
      ...
      return dp[g][c][r][idx] = min(1 + fun(0, 0, 1, idx + 1), fun(0, 1, 0, idx + 1));
  }
  else if (x == 2)
  {
    if (g == 1)
    ...
    {
      return dp[g][c][r][idx] = min(1 + fun(0, 0, 1, idx + 1), fun(1, 0, 0, idx + 1));
    }
  }
  ...
  else
  {
    ...
    {
      return dp[g][c][r][idx] = min(min(1 + fun(0, 0, 1, idx + 1), fun(0, 1, 0, idx + 1)), fun(1, 0, 0, idx + 1));
    }
  }
}
int main()
